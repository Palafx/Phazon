...
function s.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0 
		and Duel.IsExistingMatchingCard(s.filter,tp,LOCATION_DECK|LOCATION_EXTRA|LOCATION_HAND|LOCATION_GRAVE+LOCATION_REMOVED,0,1,nil,e,tp) end
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,s.filter,tp,LOCATION_DECK|LOCATION_EXTRA|LOCATION_HAND|LOCATION_GRAVE+LOCATION_REMOVED,0,1,1,nil,e,tp)
